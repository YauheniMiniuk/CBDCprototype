...
docker kill cliDigiBank cliNbrb logspout || true
./network.sh down
...
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/connection-org2.yaml" "${DIR}/organization/nbrb/gateway/"
...
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp/"* "${DIR}/../AdminApp/msp/"


cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/signcerts/"* "${DIR}/AdminApp/users/User1@org2.example.com/msp/signcerts/"
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/"* "${DIR}/AdminApp/users/User1@org2.example.com/msp/keystore/priv_sk"
